...
namespace MOSES.MGM
{
	public class MGMClient : IClientAPI
	{
		private readonly IScene m_scene;

		public MGMClient (IScene scene)
		{
			m_scene = scene;
		}
		...
		public void SendGenericMessage (string method, OpenMetaverse.UUID invoice, System.Collections.Generic.List<string> message)
		{
			throw new NotImplementedException ();
		}

		public void SendGenericMessage (string method, OpenMetaverse.UUID invoice, System.Collections.Generic.List<byte[]> message)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendMoneyBalance (OpenMetaverse.UUID transaction, bool success, byte[] description, int balance, int transactionType, OpenMetaverse.UUID sourceID, bool sourceIsGroup, OpenMetaverse.UUID destID, bool destIsGroup, int amount, string item)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendCoarseLocationUpdate (System.Collections.Generic.List<OpenMetaverse.UUID> users, System.Collections.Generic.List<OpenMetaverse.Vector3> CoarseLocations)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendInventoryFolderDetails (OpenMetaverse.UUID ownerID, OpenMetaverse.UUID folderID, System.Collections.Generic.List<InventoryItemBase> items, System.Collections.Generic.List<InventoryFolderBase> folders, int version, bool fetchFolders, bool fetchItems)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendTelehubInfo (OpenMetaverse.UUID ObjectID, string ObjectName, OpenMetaverse.Vector3 ObjectPos, OpenMetaverse.Quaternion ObjectRot, System.Collections.Generic.List<OpenMetaverse.Vector3> SpawnPoint)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendLandObjectOwners (LandData land, System.Collections.Generic.List<OpenMetaverse.UUID> groups, System.Collections.Generic.Dictionary<OpenMetaverse.UUID, int> ownersAndCount)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendSetFollowCamProperties (OpenMetaverse.UUID objectID, System.Collections.Generic.SortedDictionary<int, float> parameters)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendAvatarPicksReply (OpenMetaverse.UUID targetID, System.Collections.Generic.Dictionary<OpenMetaverse.UUID, string> picks)
		{
			throw new NotImplementedException ();
		}
		...
		public void SendAvatarClassifiedReply (OpenMetaverse.UUID targetID, System.Collections.Generic.Dictionary<OpenMetaverse.UUID, string> classifieds)
		{
			throw new NotImplementedException ();
		}
